...
/** Único para los cuatro momentos del torneo; el tipo viaja como dato. */
export const CREATE_TOURNAMENT_NOTIFICATION_EVENT_UC =
  new CreateTournamentNotificationEventUseCase(
    NOTIFICATION_EVENT_REPOSITORY,
    NOTIFICATION_DELIVERY_REPOSITORY,
  );
