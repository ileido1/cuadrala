...
export const CREATE_COURT_UC = new CreateCourtUseCase(
  COURT_REPOSITORY,
  VENUE_REPOSITORY,
  VENUE_STAFF_REPOSITORY,
);
export const LIST_COURTS_UC = new ListCourtsUseCase(COURT_REPOSITORY, VENUE_REPOSITORY);
export const UPDATE_COURT_UC = new UpdateCourtUseCase(COURT_REPOSITORY, VENUE_STAFF_REPOSITORY);
export const CANCEL_COURT_UC = new CancelCourtUseCase(COURT_REPOSITORY, VENUE_STAFF_REPOSITORY);
