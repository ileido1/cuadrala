import { ListCategoriesUseCase } from '../../application/use_cases/list_categories.use_case.js';
...
export const LIST_CATEGORIES_UC = new ListCategoriesUseCase(CATEGORY_REPOSITORY);
export const LIST_FORMAT_PRESETS_BY_SPORT_UC = new ListFormatPresetsBySportUseCase(
  FORMAT_PRESET_REPOSITORY,
);
export const PUBLISH_FORMAT_PRESET_VERSION_UC = new PublishFormatPresetVersionUseCase(
  SPORT_REPOSITORY,
  FORMAT_PRESET_REPOSITORY,
);
