...
import { getListTournamentsCON, getTournamentByIdCON, getTournamentsByVenueCON, patchTournamentStatusCON, patchTournamentVisibilityCON } from '../controllers/tournaments.controller.js';
