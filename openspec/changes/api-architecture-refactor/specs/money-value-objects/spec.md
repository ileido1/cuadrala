...
**Relación MCP:** Semántica alineada con [`multi-currency-payments/specs/money-types.md`](../../../multi-currency-payments/specs/money-types.md); requisitos de producto/API JSON MUST NOT duplicarse aquí.
