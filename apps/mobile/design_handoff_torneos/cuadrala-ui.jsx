...
function Icon({ name, size = 20, stroke = 2, style = {} }) {
  ...
  const paths = {
    ...
    trophy: <><path d="M7 4h10v5a5 5 0 01-10 0V4z" {...p} /><path d="M7 6H4.3v1.4A3.7 3.7 0 008 11M17 6h2.7v1.4A3.7 3.7 0 0116 11" {...p} /><path d="M12 14v3M8.5 20.5h7M9.5 20.5c0-1.7 1.1-3.2 2.5-3.2s2.5 1.5 2.5 3.2" {...p} /></>,
    shield: <><path d="M12 3l7 2.5v5.8c0 4.3-3 7.6-7 9.2-4-1.6-7-4.9-7-9.2V5.5L12 3z" {...p} /></>,
    trend: <><path d="M4 16.5l5-5 3.5 3.5L20 7.5" {...p} /><path d="M15 7.5h5v5" {...p} /></>,
