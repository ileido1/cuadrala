  ...
  Future<void> load() async {
    ...
    try {
      ...
      if (ratings.isNotEmpty) {
        try {
          leaderboard = await _profileRepository.getLeaderboard(
            ratings.first.categoryId,
          );
        } catch (e) {
      ...
      var myTournaments = <ViewerTournamentDto>[];
      ...
      emit(
        ProfileLoaded(
          ...
          tournamentsLoadFailed: tournamentsLoadFailed,
        ),
      );
    } catch (e) {
