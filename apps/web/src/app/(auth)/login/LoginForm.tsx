      ...
      <div className="w-full lg:w-1/2 bg-secondary-50 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="bg-surface rounded-2xl shadow-card p-8">
            ...
            {activeTab === 'register' && (
              <>
                <h3 className="text-secondary-900 font-display text-2xl font-bold mb-2">Bienvenido</h3>
                <p className="text-secondary-500 text-sm mb-6">Creá tu cuenta de administrador</p>

                <form onSubmit={handleRegisterSubmit(onRegisterSubmit)} className="space-y-5">
                  <div className="space-y-2">
                    <label htmlFor="register-fullName" className="text-sm font-medium text-secondary-700">Nombre completo</label>
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl text-secondary-900 placeholder-secondary-400 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${registerErrors.fullName ? 'border-red-400 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                    />
                    {registerErrors.fullName && (
                      <span className="text-xs text-red-600 font-medium">{registerErrors.fullName.message}</span>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label htmlFor="register-email" className="text-sm font-medium text-secondary-700">Email</label>
                    <input
                      id="register-email"
                      type="email"
                      placeholder="admin@clubpalermo.com"
                      ...
                      className={`w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl text-secondary-900 placeholder-secondary-400 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${registerErrors.email ? 'border-red-400 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                    />
                    {registerErrors.email && (
                      <span className="text-xs text-red-600 font-medium">{registerErrors.email.message}</span>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label htmlFor="register-clubName" className="text-sm font-medium text-secondary-700">Nombre del club</label>
                    <input
                      id="register-clubName"
                      type="text"
                      placeholder="Club Palermo"
                      {...registerRegister('clubName')}
                      className={`w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl text-secondary-900 placeholder-secondary-400 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${registerErrors.clubName ? 'border-red-400 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                    />
                    {registerErrors.clubName && (
                      <span className="text-xs text-red-600 font-medium">{registerErrors.clubName.message}</span>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label htmlFor="register-phone" className="text-sm font-medium text-secondary-700">Teléfono</label>
                    <input
                      id="register-phone"
                      type="tel"
                      ...
                      className={`w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl text-secondary-900 placeholder-secondary-400 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${registerErrors.phone ? 'border-red-400 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                    />
                    {registerErrors.phone && (
                      <span className="text-xs text-red-600 font-medium">{registerErrors.phone.message}</span>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label htmlFor="register-password" className="text-sm font-medium text-secondary-700">Contraseña</label>
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl text-secondary-900 placeholder-secondary-400 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${registerErrors.password ? 'border-red-400 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                    />
                    {registerErrors.password && (
                      <span className="text-xs text-red-600 font-medium">{registerErrors.password.message}</span>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label htmlFor="register-confirmPassword" className="text-sm font-medium text-secondary-700">Repetir contraseña</label>
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl text-secondary-900 placeholder-secondary-400 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${registerErrors.confirmPassword ? 'border-red-400 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                    />
                    {registerErrors.confirmPassword && (
                      <span className="text-xs text-red-600 font-medium">{registerErrors.confirmPassword.message}</span>
                    )}
                  </div>
                  ...
                  <div className="flex items-start gap-3 pt-1">
                    ...
                    />
                    <label htmlFor="acceptTerms" className="text-sm text-secondary-600 leading-tight">
                      Acepto los{' '}
                  ...
                  {registerErrors.acceptTerms && (
                    <span className="text-xs text-red-600 font-medium">{registerErrors.acceptTerms.message}</span>
                  )}
                ...
                <div className="flex items-center gap-4 my-6">
                  <div className="flex-1 h-px bg-secondary-200" />
                  <span className="text-secondary-400 text-sm">o registrate con</span>
                  <div className="flex-1 h-px bg-secondary-200" />
                </div>
