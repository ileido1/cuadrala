...
> **ARCHIVADO.** Fuente de verdad: [`docs/BACKLOG_UNIFICADO.md`](../BACKLOG_UNIFICADO.md). Design system: [`docs/DESIGN_SYSTEM.md`](../DESIGN_SYSTEM.md).
...
**UI baseline**: ver `.cursor/rules/flutter-ui-design-system-cuadrala.mdc` y `docs/DESIGN_SYSTEM.md`.
