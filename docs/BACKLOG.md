...
**Backlog Mobile (Flutter)**: historias, sprints y estado en `docs/BACKLOG_UNIFICADO.md`. Histórico en `docs/archive/` (stubs en `docs/BACKLOG_MOBILE.md` / `docs/MOBILE_SPRINTS.md`).
